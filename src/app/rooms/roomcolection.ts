...
export const roomcolection:{[key: string]: {map:string,room:(roomName:string,flagshandler: FlagHandlerService, descriptionhandler: DescriptionHandlerService, maphandler: MapHandlerService) => Room}} = {
  //map1
  room1:{map:"map1",room:room1},
  room2:{map:"map1",room:room1},
  room3:{map:"map1",room:room1},
  room4:{map:"map1",room:room1},
  room5:{map:"map1",room:room1},
  room6:{map:"map1",room:room1},
  room7:{map:"map1",room:room7},
  room8:{map:"map1",room:room1},
  room9:{map:"map1",room:room1},
  room10:{map:"map1",room:room1},
  room11:{map:"map1",room:room1},
  room12:{map:"map1",room:room1},
  room13:{map:"map1",room:room1},
  room14:{map:"map1",room:room1},
  room15:{map:"map1",room:room1},
  room16:{map:"map1",room:room1},
  room17:{map:"map1",room:room1},
  room18:{map:"map1",room:room1},
  room19:{map:"map1",room:room1},
  room20:{map:"map1",room:room1},
  room21:{map:"map1",room:room1},
  room22:{map:"map1",room:room1},
  room23:{map:"map1",room:room1},
  room24:{map:"map1",room:room1}
}
