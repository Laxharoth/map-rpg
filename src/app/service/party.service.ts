...
export class PartyService {
  ...
  set user(user:Character){this.user = user}
  setPartyMember(value:Character,index:number){if([0,1].includes(index))this.party[index] = value;}

  updateUser() { this.userSubject.next(this._user); }
